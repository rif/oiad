...
PolyFactory::addScrapper('https://1saleaday.com/jewelry', new OneSaleADayJewelryScrapper());

class OneSaleADayJewelryScrapper extends AbstractScrapper {

    protected function _fillDetails($deal, $host) {
        $deal->site_name = '1 Sale A Day Jewelry';
