...
PolyFactory::addScrapper("http://bargainbagsdaily.com/", new BargainBagsDaily());

class BargainBagsDaily extends AbstractScrapper {

	 protected function _fillDetails($deal, $host){
	 	$deal->site_name = "Bargain Bags Daily";
