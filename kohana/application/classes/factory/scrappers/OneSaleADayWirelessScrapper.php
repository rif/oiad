...
PolyFactory::addScrapper('https://1saleaday.com/wireless', new OneSaleADayWirelessScrapper());

class OneSaleADayWirelessScrapper extends AbstractScrapper {

    protected function _fillDetails($deal, $host) {
        $deal->site_name = '1 Sale A Day Wireless';
