...
PolyFactory::addScraper("http://www.electronics-expo.com/index.php?page=item&id=MONDLHDHSST8AC&source=DailyDeal", new ElectronicsExpo());

class ElectronicsExpo extends AbstractScraper {
