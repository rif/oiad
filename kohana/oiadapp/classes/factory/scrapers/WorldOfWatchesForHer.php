...
PolyFactory::addScraper("http://www.worldofwatches.com/cust/dailydealladies.asp", new WorldOfWatchesForHer());

class WorldOfWatchesForHer extends AbstractScraper {
